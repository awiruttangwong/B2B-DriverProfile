...
/**
 * จำนวนคนขับที่ยังวิ่งงานอยู่ใน 90 วันล่าสุดและยังไม่เคยถูกประเมิน
 * โชว์เป็นตัวเลขบนเมนูให้เห็นว่ามีงานค้าง — ต้องใช้เงื่อนไขเดียวกับค่าเริ่มต้น
 * ของหน้า /pending เสมอ ไม่งั้นตัวเลขจะไม่ตรงกันข้ามหน้า
 *
 * ไม่นับทุกคนที่ยังไม่เคยประเมิน (จะได้ 1,290) เพราะกว่าครึ่งเป็นคนที่วิ่ง
 * ครั้งเดียวแล้วไม่กลับมาอีกเลย ตัวเลขแบบนั้นทำให้ท้อโดยไม่จำเป็น
 */
