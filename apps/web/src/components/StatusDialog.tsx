...
const OPTIONS: {
  ...
  {
    v: 'active',
    desc: 'รับงานได้ปกติและแสดงผลในหน้าหา พขร. เพื่อเข้ารับงาน',
    tone: 'ok',
  },
  {
    v: 'probation',
    desc: 'รับงานได้ปกติและแสดงผลในหน้าหา พขร. เพื่อเข้ารับงาน แต่ทีมงานจะติดตามพฤติกรรมเป็นพิเศษในช่วงนี้',
    tone: 'warn',
  },
  {
    v: 'inactive',
    desc: 'ระงับการรับงาน จะไม่แสดงผลในหน้าหา พขร. เพื่อเข้ารับงานจนกว่าจะเปลี่ยนสถานะ',
    tone: 'warn',
  },
  {
    v: 'blacklisted',
        ...
        <div className="card-pad">
          ...
          {needsReason && (
            <div className="field" style={{ marginTop: 16 }}>
              ...
              <textarea
                ...
                style={{ minHeight: 76 }}
                placeholder="เช่น ทำสินค้าเสียหาย 3 ครั้งใน 1 เดือน ลูกค้าขอไม่ให้ส่งคนนี้อีก หรืออื่นๆ"
              />
            </div>
          )}
          ...
          {changed && needsReason && (
            <div className="note-box warn" style={{ marginTop: 14 }}>
              หลังบันทึก <strong>{driverName}</strong> จะไม่แสดงผลในหน้า “หา พขร. เพื่อเข้ารับงาน”
              จนกว่าจะเปลี่ยนสถานะ ส่วนประวัติงานและการประเมินเดิมยังอยู่ครบไม่หายไปไหน
            </div>
          )}
          ...
          <p className="hint" style={{ marginTop: 10 }}>
            ทุกการเปลี่ยนสถานะถูกบันทึกไว้ว่าใครเปลี่ยน เมื่อไร และเพราะอะไร
          </p>
        </div>
      </div>
    </div>
