      ...
      {results.data && (
        <>
          ...
          <div className="note-box" style={{ marginTop: 16 }}>
            ...
            &ldquo;ไม่ดี&rdquo; — ที่เหลือจะขึ้นกลุ่มบนได้ต้องเคยมีประสบการณ์จริงตรงกับทุกช่องที่ระบุมา
            (ลูกค้า/ประเภทรถ/เส้นทาง) ก่อน เช่น ระบุทั้งลูกค้าและประเภทรถ คนที่ไม่เคยขับรถประเภทนั้น
            เลยจะไม่ขึ้นกลุ่มบนแม้จะมีเที่ยวกับลูกค้ารายนี้เยอะก็ตาม ภายในกลุ่มเดียวกันจึงเรียงตาม
            น้ำหนักลูกค้า/ประเภทรถ/เส้นทาง เสมอกันจึงดูคะแนน แล้วตามด้วยประสบการณ์รวมและความสดของงานล่าสุด
          </div>
        </>
      )}
    </main>
