...
export default function FindDriver() {
  ...
  // โหลดเพิ่มได้แทน ตั้งแต่ 0018 ตัวกรองลูกค้า/ประเภทรถ/เส้นทางตัดคนไม่ตรงเงื่อนไข
  // ออกจากผลลัพธ์เลย (ไม่ใช่แค่จัดลำดับ) จำนวนที่เหลือให้โหลดเพิ่มจึงอาจน้อยกว่า
  // จำนวนคนขับที่ผ่านสถานะทั้งระบบมาก
    ...
    <main className="page">
      ...
      <div className="card card-pad" style={{ marginBottom: 18 }}>
        ...
        <p className="hint" style={{ marginTop: 10 }}>
          ยิ่งระบุมาก ผลลัพธ์ยิ่งเจาะจง — ช่องที่ระบุจะตัดคนที่ไม่เคยมีประสบการณ์ตรงกับเงื่อนไขนั้น
          ออกจากผลลัพธ์ไปเลย ไม่ใช่แค่จัดลำดับใหม่ จุดฟ้าข้างชื่อช่องคือช่องที่ควรกรอกถัดไป
      ...
      {results.data && (
        <>
          ...
          <div className="note-box" style={{ marginTop: 16 }}>
            ...
            {submitted && (submitted.customer || submitted.vehicleType || submitted.route.trim()) ? (
              <>
                : ระบุเงื่อนไขมาแล้วจึงแสดงเฉพาะคนที่เคยมีประสบการณ์จริงตรงกับ
                <em> ทุกช่อง</em>ที่ระบุมา (ลูกค้า/ประเภทรถ/เส้นทาง) อย่างน้อยข้อละ 1 เที่ยวเท่านั้น
                คนที่ไม่เคยตรงเลยแม้แต่ช่องเดียวจะไม่ถูกนับเป็นตัวเลือก ต่อให้มีประสบการณ์รวมทั้งระบบ
                เยอะแค่ไหนก็ตาม — ในกลุ่มที่ผ่านเงื่อนไข เริ่มจากกดคนที่เคยมีปัญหา (ไม่มารับงาน/มีเหตุ)
                ใน 12 เดือนล่าสุด และคนที่ถูกประเมินต่ำกว่า 3.00 ลงไปไว้ท้าย (คนที่ยังไม่เคยถูกประเมิน
                ไม่ถือว่าแย่ เพราะ &ldquo;ไม่รู้&rdquo; ไม่เท่ากับ &ldquo;ไม่ดี&rdquo;) แล้วเรียงตาม
                น้ำหนักลูกค้า/ประเภทรถ/เส้นทาง เสมอกันจึงดูคะแนน แล้วตามด้วยประสบการณ์รวมและความสด
              </>
            ) : (
              <>
                : ยังไม่ได้ระบุเงื่อนไข จึงแสดงคนขับที่พร้อมทำงานทุกคน เริ่มจากกดคนที่เคยมีปัญหา
                (ไม่มารับงาน/มีเหตุ) ใน 12 เดือนล่าสุด และคนที่ถูกประเมินต่ำกว่า 3.00 ลงไปไว้ท้าย
                (คนที่ยังไม่เคยถูกประเมินไม่ถือว่าแย่) แล้วเรียงตามประสบการณ์รวมและความสดของงานล่าสุด
              </>
            )}
          </div>
        </>
