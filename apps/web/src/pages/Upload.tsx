    ...
    <main className="page">
      <div className="page-head">
        <div>
          ...
          <p>
            อัปโหลดไฟล์ เที่ยวที่เคยนำเข้าไปแล้วจะถูกข้ามให้เองเสมอ ไม่ทำให้ข้อมูลซ้ำ
            ส่วนหัวตารางระบบตรวจจับให้อัตโนมัติ
          </p>
        </div>
      </div>
          ...
          <div className="card card-pad template-cta">
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <p className="muted" style={{ margin: '2px 0 0', fontSize: 13 }}>
                ดาวน์โหลดเทมเพลตนี้ไปกรอกได้เลย หัวตารางตรงกับที่ระบบจัดเตรียมไว้แล้วทุกคอลัมน์
                เพื่อป้องกันเรื่องการจับคู่คอลัมน์ผิดพลาด
              </p>
            </div>
            <button
              type="button"
